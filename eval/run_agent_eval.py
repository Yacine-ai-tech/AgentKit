...
def main():
    ...
    test_queries = [
        {"query": "What drove company finance revenue recently?", "expected_tools": ["finance_kpis"]},
        {"query": "How is our headcount in People?", "expected_tools": ["people_kpis"]},
        {"query": "What is the forecast for revenue?", "expected_tools": ["forecast_revenue"]},
        {"query": "Are there any anomalies in our finance data?", "expected_tools": ["finance_anomalies"]}
    ]
