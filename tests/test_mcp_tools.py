...
async def test_query_kpis_returns_dict():
    ...
    from agentkit_mcp.mcp_server import query_kpis
...
async def test_get_company_health_returns_dict():
    from agentkit_mcp.mcp_server import get_company_health
...
async def test_detect_anomalies_returns_dict():
    from agentkit_mcp.mcp_server import detect_kpi_anomalies
...
async def test_forecast_metric_returns_dict():
    from agentkit_mcp.mcp_server import forecast_metric
...
async def test_list_metrics_returns_dict():
    from agentkit_mcp.mcp_server import list_available_metrics
